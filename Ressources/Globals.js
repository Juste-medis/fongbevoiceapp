export default {
  ...
  IMAGES: {
    ...
    USER_PHOTO: require('../Images/user_photo.png'),
    LOGINROUNDER: require('../Images/Subtract.png'),
  ...
  STRINGS: {
    ...
    required_field: 'Un ou plusieurs champs sont manquants !',
    save: 'Enrégistrés',
    passNotMatch: 'Les mots de passes de se conviennent pas .',
    checked: 'Validé',
    gain: 'GAINS',
    note: 'Note',
    checkout: 'Encaisser',
    ...
    small_code: 'mot de passe invalide (entrez au moins 5 caractères)',
    ...
    invalid_mail: 'Addresse email non applicable .',
    phone: 'Numéro de Téléphone',
    address: 'Addresse',
    language: 'Language',
    remenber: 'Se souvenir',
    Profil: 'Profil',
    retry: 'Réessayez',
    modify: 'modifier',
    copy: 'copier',
    ...
    search: 'Rechercher',
    hello: 'Bienvenu',
    by_connecting: 'En vous connectant vous reconnaissez avoir ',
    read_tems: 'lu les Termes et conditions',
    terminated: 'terminés',
    other: 'autre',
    total: 'Total',
